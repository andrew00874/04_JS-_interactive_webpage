const productData = {
  1: {
    ...
    price: "29,900원",
    image:
      "https://image.msscdn.net/thumbnails/images/goods_img/20210428/1924274/1924274_17152551704806_big.jpg?w=1200",
    description:
      "시원한 소재로 만들어진 와이드 밴딩 팬츠입니다. 착용감이 매우 편안합니다.",
  ...
  2: {
    ...
    price: "18,000원",
    image:
      "https://image.msscdn.net/thumbnails/images/goods_img/20240326/3993145/3993145_17153177813685_big.jpg?w=1200",
  ...
  3: {
    ...
    price: "89,000원",
    image:
      "https://image.msscdn.net/thumbnails/images/goods_img/20220310/2403986/2403986_1_500.jpg",
    description: "미니멀한 디자인의 클래식 싱글 블레이저입니다.",
    detail_img:
      "https://gi.esmplus.com/noblesse07/nobless/2023/2302/230217/jk2434/jk2434_d_01.jpg",
    // 👇 아래 속성들 추가
    category: "아우터",
    isNew: false,
    isBest: true,
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (product) {
    ...
    document.querySelector(".product-detail-image img").src =
      product.detail_img;
